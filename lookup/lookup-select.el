...
;; Version: $Id: lookup-select.el,v 1.3 2003/04/14 16:01:03 tnemoto Exp $
...
;  (define-key lookup-select-mode-map "i" 'lookup-select-info)
  ...
  (define-key lookup-select-mode-map "C" 'lookup-select-copyright)
