;;; Wine.el Color-Mate wine red color theme -*-emacs-lisp-*-
...
;; $Id: Wine.el,v 1.2 2002/05/11 02:32:26 elca Exp $

(setq color-mate:theme
      '(
	(frame-background-color .          "LightPink")
	;(frame-foreground-color .         "black")
	;(frame-height . 40)
	;(frame-width . 80)
	(modeline-background-color . "VioletRed")
