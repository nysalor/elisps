;;; SunnyDay-LCD.el Color-Mate standard definition for note PC -*-emacs-lisp-*-
...
;; $Id: SunnyDay-LCD.el,v 1.2 2002/05/11 02:32:26 elca Exp $
...
(setq color-mate:theme
	...
	(region-background-color . "gray80")
