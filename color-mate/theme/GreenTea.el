;;; GreenTea.el Color-Mate theme -*-emacs-lisp-*-
...
;; $Id: GreenTea.el,v 1.2 2002/05/11 02:32:26 elca Exp $

(setq color-mate:theme
      '(
	(frame-background-color .          "PaleGreen1")
	;(frame-foreground-color .         "black")
	;(frame-height . 40)
	;(frame-width . 80)
	(modeline-background-color . "brown")
	(modeline-foreground-color . "wheat")
	;(modeline-underlined . nil)
	(modeline-buffer-id-foreground-color . "khaki")
